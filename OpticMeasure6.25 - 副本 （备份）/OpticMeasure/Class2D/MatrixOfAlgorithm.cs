...
namespace CSharpAlgorithm.Algorithm
{
	...
	* @version 1.0
	*/
	public class MatrixOfAlgorithm 
	{
		 ...
		 * @param nCols - 指定的矩阵列数
		 */
		public MatrixOfAlgorithm(int nRows, int nCols)
		{
			numRows = nRows;
			numColumns = nCols;
			Init(numRows, numColumns);
		 ...
		 */
		public MatrixOfAlgorithm(double[,] value)
		{
		 ...
		 */
		public MatrixOfAlgorithm(int nRows, int nCols, double[] value)
		{
			numRows = nRows;
			numColumns = nCols;
			Init(numRows, numColumns);
		 ...
		 * @param nSize - 方阵行列数
		 */
		public MatrixOfAlgorithm(int nSize)
		{
			numRows = nSize;
			numColumns = nSize;
			Init(nSize, nSize);
		 ...
		 */
		public MatrixOfAlgorithm(int nSize, double[] value)
		{
			numRows = nSize;
			numColumns = nSize;
			Init(nSize, nSize);
		 ...
		 * @param other - 源矩阵
		 */
		public MatrixOfAlgorithm( MatrixOfAlgorithm other)
		{
		 ...
		 * @return Matrix对象
		 */
		public static MatrixOfAlgorithm operator +(MatrixOfAlgorithm m1, MatrixOfAlgorithm m2)
		{
			return m1.Add(m2);
		}
		 ...
		 * @return double[]对象
		 */
		public static implicit operator double[](MatrixOfAlgorithm m)
		{
			return m.elements;
		}
		 ...
		 */
		public MatrixOfAlgorithm SetValue(MatrixOfAlgorithm other)
		{
			if (other != this)
			{
		...
		{
			MatrixOfAlgorithm matrix = other as MatrixOfAlgorithm;
			if (matrix == null)
				return false;
		 ...
		 * @如果矩阵的行/列数不匹配，则会抛出异常
		 */
		public MatrixOfAlgorithm Add(MatrixOfAlgorithm other) 
		{
			// 首先检查行列数是否相等
			...
			// 构造结果矩阵
			MatrixOfAlgorithm	result = new MatrixOfAlgorithm(this) ;		// 拷贝构造
		 ...
		 * @如果矩阵的行/列数不匹配，则会抛出异常
		 */
		public MatrixOfAlgorithm Subtract(MatrixOfAlgorithm other) 
		{
			if (numColumns != other.GetNumColumns() ||
				numRows != other.GetNumRows())
				throw new Exception("矩阵的行/列数不匹配。");
		 ...
		 */
		public MatrixOfAlgorithm Multiply(double value) 
		{
			// 构造目标矩阵
			MatrixOfAlgorithm	result = new MatrixOfAlgorithm(this) ;		// copy ourselves
		 ...
		 * @如果矩阵的行/列数不匹配，则会抛出异常
		 */
		public MatrixOfAlgorithm Multiply(MatrixOfAlgorithm other) 
		{
			// 首先检查行列数是否符合要求
			...
			MatrixOfAlgorithm	result = new MatrixOfAlgorithm(numRows, other.GetNumColumns());
		 ...
		 */
		public bool Multiply(MatrixOfAlgorithm AR,  MatrixOfAlgorithm AI,  MatrixOfAlgorithm BR,  MatrixOfAlgorithm BI, MatrixOfAlgorithm CR, MatrixOfAlgorithm CI) 
		{
			// 首先检查行列数是否符合要求
			...
			// 构造乘积矩阵实部矩阵和虚部矩阵
			MatrixOfAlgorithm mtxCR = new MatrixOfAlgorithm(AR.GetNumRows(), BR.GetNumColumns());
			MatrixOfAlgorithm mtxCI = new MatrixOfAlgorithm(AR.GetNumRows(), BR.GetNumColumns());
			// 复矩阵相乘
		 ...
		 */
		public MatrixOfAlgorithm Transpose() 
		{
			// 构造目标矩阵
			MatrixOfAlgorithm	Trans = new MatrixOfAlgorithm(numColumns, numRows);
		 ...
		 * @return bool型，求逆是否成功
		 */
		public bool InvertGaussJordan(MatrixOfAlgorithm mtxImag)
		{
			int i,j,k,l,u,v,w;
			double p,q,s,t,d,b;
		 ...
		 * @return bool型，求解是否成功
		 */
		public bool SplitLU(MatrixOfAlgorithm mtxL, MatrixOfAlgorithm mtxU)
		{ 
			int i,j,k,w,v,ll;
		 ...
		 * @return bool型，求解是否成功
		 */
		public bool SplitQR(MatrixOfAlgorithm mtxQ)
		{ 
			int i,j,k,l,nn,p,jj;
			double u,alpha,w,t;
		 ...
		 * @return bool型，求解是否成功
		 */
		public bool SplitUV(MatrixOfAlgorithm mtxU, MatrixOfAlgorithm mtxV, double eps)
		{ 
		 ...
		 * @return bool型，求解是否成功
		 */
		public bool InvertUV(MatrixOfAlgorithm mtxAP, MatrixOfAlgorithm mtxU, MatrixOfAlgorithm mtxV, double eps)
		{ 
			int i,j,k,l,t,p,q,f;
		 ...
		 * @return bool型，求解是否成功
		 */
		public bool MakeSymTri(MatrixOfAlgorithm mtxQ, MatrixOfAlgorithm mtxT, double[] dblB, double[] dblC)
		{ 
			int i,j,k,u;
			double h,f,g,h2;
		 ...
		 * @return bool型，求解是否成功
		 */
		public bool ComputeEvSymTri(double[] dblB, double[] dblC, MatrixOfAlgorithm mtxQ, int nMaxIt, double eps)
		{
			int i,j,k,m,it,u,v;
		 ...
		 * @return bool型，求解是否成功
		 */
		public bool ComputeEvJacobi(double[] dblEigenValue, MatrixOfAlgorithm mtxEigenVector, int nMaxIt, double eps)
		{ 
		 ...
		 * @return bool型，求解是否成功
		 */
		public bool ComputeEvJacobi(double[] dblEigenValue, MatrixOfAlgorithm mtxEigenVector, double eps)
		{ 
			int i,j,p,q,u,w,t,s;
