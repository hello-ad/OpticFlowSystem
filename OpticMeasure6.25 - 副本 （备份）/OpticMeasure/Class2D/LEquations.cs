...
namespace CSharpAlgorithm.Algorithm
{
	...
	{
		private MatrixOfAlgorithm	mtxLECoef;		// 系数矩阵
		private MatrixOfAlgorithm mtxLEConst;		// 常数矩阵
		 ...
		 */
		public LEquations(MatrixOfAlgorithm mtxCoef, MatrixOfAlgorithm mtxConst)
		{
		 ...
		 */
		public bool Init(MatrixOfAlgorithm mtxCoef, MatrixOfAlgorithm mtxConst)
		{
			if (mtxCoef.GetNumRows() != mtxConst.GetNumRows())
				return false;

			mtxLECoef = new MatrixOfAlgorithm(mtxCoef);
			mtxLEConst = new MatrixOfAlgorithm(mtxConst);
		 ...
		 */
		public MatrixOfAlgorithm GetCoefMatrix()
		{
			return mtxLECoef;
		}
		 ...
		 * @return Matrix 型，返回系数矩阵
		 */
		public MatrixOfAlgorithm GetConstMatrix()
		{
			return mtxLEConst;
		}
		 ...
		 */
		public bool GetRootsetGauss(MatrixOfAlgorithm mtxResult)
		{ 
		 ...
		 * @return bool 型，方程组求解是否成功
		 */
		public bool GetRootsetGaussJordan(MatrixOfAlgorithm mtxResult)
		{ 
			int l,k,i,j,nIs=0,p,q;
			double d,t;
		 ...
		 * @return bool 型，方程组求解是否成功
		 */
		public bool GetRootsetGauss(MatrixOfAlgorithm mtxCoefImag, MatrixOfAlgorithm mtxConstImag, MatrixOfAlgorithm mtxResult, MatrixOfAlgorithm mtxResultImag)
		{ 
		 ...
		 * @return bool 型，方程组求解是否成功
		 */
		public bool GetRootsetGaussJordan(MatrixOfAlgorithm mtxCoefImag, MatrixOfAlgorithm mtxConstImag, MatrixOfAlgorithm mtxResult, MatrixOfAlgorithm mtxResultImag)
		{
			int l,k,i,j,nIs=0,u,v;
			double p,q,s,d;
		 ...
		 * @return bool 型，方程组求解是否成功
		 */
		public bool GetRootsetTriDiagonal(MatrixOfAlgorithm mtxResult)
		{ 
			int k,j;
			double s;
		 ...
		 * @return bool 型，方程组求解是否成功
		 */
		public bool GetRootsetBand(int nBandWidth, MatrixOfAlgorithm mtxResult)
		{ 
		 ...
		 * @return bool 型，方程组求解是否成功
		 */
		public bool GetRootsetDjn(MatrixOfAlgorithm mtxResult)
		{ 
			int i,j,l,k,u,v,w,k1,k2,k3;
			double p;

			// 方程组属性，将常数矩阵赋给解矩阵
			MatrixOfAlgorithm mtxCoef = new MatrixOfAlgorithm(mtxLECoef);
			mtxResult.SetValue(mtxLEConst);
		 ...
		 * @return bool 型，方程组求解是否成功
		 */
		public bool GetRootsetCholesky(MatrixOfAlgorithm mtxResult)
		{ 
			int i,j,k,u,v;
		 ...
		 * @return bool 型，方程组求解是否成功
		 */
		public bool GetRootsetGgje(MatrixOfAlgorithm mtxResult)
		{ 
			int i,j,k,nIs=0,u,v;
			double d,t;
		 ...
		 * @return bool 型，方程组求解是否成功
		 */
		public bool GetRootsetTlvs(MatrixOfAlgorithm mtxResult)
		{ 
			int i,j,k;
			double a,beta,q,c,h;
		 ...
		 * @return bool 型，方程组求解是否成功
		 */
		public bool GetRootsetGaussSeidel(MatrixOfAlgorithm mtxResult, double eps)
		{ 
			int i,j,u,v;
			double p,t,s,q;
		 ...
		 * @param eps - 控制精度
		 */
		public void GetRootsetGrad(MatrixOfAlgorithm mtxResult, double eps)
		{ 
			int i,k;
			...
			// 构造临时矩阵
			MatrixOfAlgorithm mtxP = new MatrixOfAlgorithm(n, 1);
			...
			while (i<=n-1)
			{ 
				MatrixOfAlgorithm mtxS = mtxLECoef.Multiply(mtxP);
				...
				MatrixOfAlgorithm mtxQ = mtxLECoef.Multiply(mtxResult);
		 ...
		 * @return bool 型，方程组求解是否成功
		 */
		public bool GetRootsetMqr(MatrixOfAlgorithm mtxResult, MatrixOfAlgorithm mtxQ, MatrixOfAlgorithm mtxR)
		{ 
			int i,j;
			double d;
		 ...
		 * @return bool 型，方程组求解是否成功
		 */
		public bool GetRootsetGinv(MatrixOfAlgorithm mtxResult, MatrixOfAlgorithm mtxAP, MatrixOfAlgorithm mtxU, MatrixOfAlgorithm mtxV, double eps)
		{ 
			int i,j;
			...
			// 临时矩阵
			MatrixOfAlgorithm mtxA = new MatrixOfAlgorithm(mtxLECoef);
		 ...
		 * @return bool 型，方程组求解是否成功
		 */
		public bool GetRootsetMorbid(MatrixOfAlgorithm mtxResult, int nMaxIt /*= 60*/, double eps)
		{ 
			int i, k;
			double q, qq;
			...
			{ 
				...
				// 矩阵运算
				MatrixOfAlgorithm mtxE = mtxLECoef.Multiply(mtxResult);
				MatrixOfAlgorithm mtxR = mtxLEConst.Subtract(mtxE);

				// 用全选主元高斯消元法求解
				leqs = new LEquations(mtxLECoef, mtxR);
				MatrixOfAlgorithm mtxRR = new MatrixOfAlgorithm();
